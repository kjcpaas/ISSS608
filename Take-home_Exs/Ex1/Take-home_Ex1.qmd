...
(q1_yoy_psf_price_all_markets_graph |
...
```{r}
realis_per_unit %>% filter(QUARTER == "2024Q1") %>%
...
median_q1 <- median(q12024$UNIT_PRICE_PSF)
mean_q1 <- mean(q12024$UNIT_PRICE_PSF)

unit_price_by_prop_type <- ggplot(q12024,
...
#| code-fold: true
#| code-summary: "Show ggplot2 code"
(unit_price_by_prop_type / sales_volume_by_prop_type ) +
  plot_layout(heights = c(5,1)) +
  plot_annotation(title = "Private Property Sales by Property Type for 2024 Q1",
...
<https://www.hdb.gov.sg/residential/buying-a-flat/executive-condominium>
