...
### 5.2.3 Visualization Decision - Hide inactive edges
...
Animations for network plots don't seem to be fully supported by both `plotly` (`geom_edge_line` and `geom_edge_fan` are not rendered) and `gganimate` (does not accept `ggraph` plot)

Instead of animations, we will just use Quarto's **tabset** to show the changes. For the project, we can use Shiny's functions to simulate animations.
:::
...
supernetwork %>%
  ...
  plot_fishing_power(
    ...
    title = "Power Graph: SouthSeafood Express Corp's Sphere of Influence (June 2024)",
    subtitle = "Entities with 3 degrees of separation from **SouthSeafood Express Corp**. This is where the influence of the<br />company is noticeable."
  )
```
...
supernetwork %>%
  ...
  plot_fishing_power(
    ...
    node_size = 5,
    arrow_margin = 2,
    title = "Power Graph: SouthSeafood Express Corp's Full Network (June 2024)",
    subtitle = "This shows the full view of the network connected to SouthSeafood Express Corp in any way."
  )
```
...
Although not liked as family members, it is highly likely that **Liam Conti**, **Lemuel Conti**, and **Fabio Conti** are part of a clan that controls is part of the fishing business network.

However, the analysis at this point is still subjective as it depends on which catches the viewer's attention. We need a more objective way to identify influential nodes.
:::
:::
...
## 7.3 Identifying the most powerful nodes
...
sfec_sphere_of_influence_power %>%
  plot_centrality(
    "pagerank",
    title = "Most Powerful Nodes: SouthSeafood Express Corp's Sphere of Influence (June 2024)",
...
sfec_connected_network_power %>%
  plot_centrality(
    "pagerank",
    title = "Most Powerful Nodes: SouthSeafood Express Corp's Connected Network (June 2024)",
    subtitle = "A higher value of **pagerank centrality** means the entity has higher power and benefits from the network."
  )
```
...
Although she was **not identified** when we were visually inspecting the power plots, using *pagerank* centrality identies her as the most powerful person in the network. This further confirms our hypothesis and observations that the **Conti Clan** controls this part of the fishing business network.
:::

## 7.4 Identifiying the power brokers

### 7.4.1 Sphere of Influence
...
sfec_sphere_of_influence_power %>%
  plot_centrality(
    "betweenness",
    title = "Power Brokers: SouthSeafood Express Corp's Sphere of Influence (June 2024)",
...
sfec_connected_network_power %>%
  plot_centrality(
    "betweenness",
    title = "Power Brokers: SouthSeafood Express Corp's Connected Network",
    subtitle = "A higher value of **betweenness centrality** means the entity is more capable of connecting entities."
  )
```
...
## 7.5 Curious case of Sanaa El-Amin
...
sea_sphere_of_influence_power %>%
  plot_centrality(
    ...
    title = "Power Brokers: Sanaa El-Amin's Sphere of Influence (June 2024)",
    subtitle = "A higher value of **betweenness centrality** means the entity is more capable of connecting entities."
  )
```
...
### 7.5.1 Measures of centrality to identify this influence
