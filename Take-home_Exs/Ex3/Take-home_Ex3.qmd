...
STYLES = list(
  ...
  # Colors
  primary_color = "blue",
  primary_light_color = "cornflowerblue",
  secondary_color = "darkorange",
  secondary_light_color = "peachpuff",
  muted_color = "grey50",
  ...
  default_caption = "Hover on the nodes to see their full names",
...
Common theme elements, another `theme()` definition can be used if these elements need to be overriden.

```{r}
COMMON_THEME = theme(
  text = element_text(family = STYLES$font_family),
  plot.title = element_markdown(
    face = "bold",
    color = STYLES$primary_color,
    size = unit(10, "pt")
  ),
  plot.subtitle = element_markdown(color = STYLES$normal_text_color, size = unit(8, "pt")),
  ,
  plot.caption = element_markdown(
    color = STYLES$normal_text_color,
    size = unit(6, "pt"),
    hjust = 0
  ),
  ...
  legend.text = element_text(size = unit(6, "pt"), vjust = 0.45),
