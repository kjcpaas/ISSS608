---
title: "In-class Exercise 6: Visualising and Analysing Network Data"
...
```{r}
#| label: setup
pacman::p_load(tidyverse, quanteda, corporaexplorer, rvest, stringi)
```

## 2.2 Loading the data

```{r}
bible <- readr::read_lines(url("http://www.gutenberg.org/cache/epub/10/pg10.txt"))
```

# 3 Pre-processing the data

## 3.1 Splitting books and chapters
...
## 3.3 **Creating data frame with text and metadata**
