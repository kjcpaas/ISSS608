...
Since Age and Mfg Year have high correlation, we will remove one of them. We will retain Age.
:::
...
We can also perform the complete set of tests by using [*check_model()*](https://easystats.github.io/performance/reference/check_model.html).
